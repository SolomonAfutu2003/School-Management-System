...
const EditDetail = () => {
    ...
    useEffect(() => {
        ...
        const foundGuardian = GuardiansData.guardians.find(g => g.guardian_id === id);
                    ...
                    <div className='w-full'>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <section className='grid grid-cols-4 gap-x-5 gap-y-4'>
                                ...
                                <div>
                                    <h2 className="text-sm font-normal text-gray-400">ID</h2>
                                    <input defaultValue={data.guardian_id} className="border border-[#D1D5DB] px-2 py-1" type="text" name="" id="" />
                                </div>
                                <div>
                                    <h2 className="text-sm font-normal text-gray-400">ADDRESS</h2>
                                    <input defaultValue={data.address} className="border border-[#D1D5DB] px 2 py-1" type="text" name="" id="" />
                                ...
                                <div>
                                    <h2 className="text-sm font-normal text-gray-400">PHONE NUMBER</h2>
                                    <input defaultValue={data.phone} className="border border-[#D1D5DB] px-2 py-1" type="text" name="" id="" />
                                </div>
                                <div>
                                    <h2 className="text-sm font-normal text-gray-400">EMAIL</h2>
                                    <input defaultValue={data.email} className="border border-[#D1D5DB] px-2 py-1" type="text" name="" id="" />
                                </div>
                            </section>
                        </div>
                    </div>
